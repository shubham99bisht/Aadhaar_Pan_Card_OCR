...
def draw_boxes(img, image_name, boxes, scale):
    ...
    with open('data/results/' + 'res_{}.txt'.format(base_name.split('.')[0]), 'w') as f:
        for box in boxes:
            ...
            # height = max_y - min_y
            # if height/img.shape[0] < 0.05:
            #     continue
            #
            # if min_y/img.shape[0] < 0.16 and min_x/img.shape[1]<0.6:
            #     continue
            #
            # if min_y/img.shape[0] < 0.065:
            #     continue
            #
            # if min_x/img.shape[1]<0.1:
            #     if max_x/img.shape[1] > 0.2:
